...
<body>
    ...
    <div class="room">
        ...
        <button style="position: absolute; top: 10px; right: 10px;" class="btn btn-primary" onclick="createOpenModel();">Add Room</button>
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header">
                        ...
                        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close" onclick="createCloseModel();"><span aria-hidden="true"></span></button>
                    </div>
