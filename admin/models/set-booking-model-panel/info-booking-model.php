...
<div class="modelinfo">
            <h4 style="font-size: 16px;">Booking Information</h4>
                    ...
                    <div style="display: flex; align-items: center; gap: 8px; width: 100%; max-width: 350px; margin-bottom: 12px;">
                        <label for="mealInput" style="margin: 0; font-size: 16px; cursor: pointer; display: flex; align-items: center;">
                            <input type="checkbox" name="Meal" id="mealInput" style="margin-right: 8px; accent-color: #ffb300; width: 22px; height: 22px; min-width: 22px; min-height: 22px; cursor: pointer; vertical-align: middle;" onchange="toggleMealIconColor(this)">
                            ...
                            <svg id="mealIconSvg" width="22" height="22" viewBox="0 0 22 22" style="vertical-align: middle; margin-right: 6px;" fill="none" xmlns="http://www.w3.org/2000/svg">
                                ...
                                <!-- Egg yolk -->
                                <circle id="eggYolk" cx="11" cy="12" r="0.9" fill="#ffb300"/>
                                <!-- Toast/Bread -->
                            ...
                            function toggleMealIconColor(checkbox) {
                                var yolk = document.getElementById('eggYolk');
                                if (checkbox.checked) {
